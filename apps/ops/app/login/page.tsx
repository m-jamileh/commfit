    ...
    <div className="min-h-screen flex items-center justify-center bg-bg">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-2xl font-semibold text-text-primary">Comm-Fit Ops</h1>
          <p className="text-sm text-text-secondary mt-1">Internal Operations Portal</p>
        </div>
        ...
        <div className="bg-surface rounded-xl border border-border shadow-md p-6">
          ...
          <p className="text-xs text-center text-text-muted mt-4">
            Demo: use any <code>@commfit.com</code> email with any password.
          </p>
        </div>
      </div>
    </div>
